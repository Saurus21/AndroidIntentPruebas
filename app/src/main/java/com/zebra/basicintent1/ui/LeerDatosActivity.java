...
public class LeerDatosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nuevoInventario.setCodigoBarra("leerDatosActivity");
        ...
        btnAgregarDatos.setOnClickListener(v -> mostrarDialogoAgregarInventario()); // antes tenia mostrarDialogoAgregarRegistro()
