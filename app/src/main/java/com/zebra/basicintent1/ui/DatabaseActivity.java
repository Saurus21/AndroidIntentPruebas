...
public class DatabaseActivity extends AppCompatActivity {
    ...
    private void cargarDatosDesdeBaseDeDatos() {
        ...
        db.scannedDataDao().getAllScannedData().observe(this, scannedDataList -> {
            ...
            adapter.actualizarDatos(scannedDataList);
            progressBar.setVisibility(View.GONE);

            // Debug: Verificar datos recibidos
            Log.d("DATABASE_DEBUG", "Datos recibidos: " + scannedDataList.size());
            for (ScannedData data : scannedDataList) {
                Log.d("DATABASE_DEBUG", "Item: " + data.getData());
            }
        });
    }
